...
c.AdWidth+"px%3B%20height%3A%20"+c.AdHeight+"px%3B%22%3E%09%0A%3C%2Fdiv%3E"))}}}function J(b){var d=null,f=null,e=function(c){var d=dv_GetParam(c,"cmp");c=dv_GetParam(c,"ctx");return"919838"==c&&"7951767"==d||"919839"==c&&"7939985"==d||"971108"==c&&"7900229"==d||"971108"==c&&"7951940"==d?"</scr'+'ipt>":/<\/scr\+ipt>/g}(b.src);"function"!==typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")});var c=function(b){!(b=b.previousSibling)||"#text"!=b.nodeName||
null!=b.nodeValue&&void 0!=b.nodeValue&&0!=b.nodeValue.trim().length||(b=b.previousSibling);if(b&&"SCRIPT"==b.tagName&&b.getAttribute("type")&&("text/adtag"==b.getAttribute("type").toLowerCase()||"text/passback"==b.getAttribute("type").toLowerCase())&&""!=b.innerHTML.trim()){if("text/adtag"==b.getAttribute("type").toLowerCase())return d=b.innerHTML.replace(e,"\x3c/script>"),{isBadImp:!1,hasPassback:!1,tagAdTag:d,tagPassback:f};if(null!=f)return{isBadImp:!0,hasPassback:!1,tagAdTag:d,tagPassback:f};
f=b.innerHTML.replace(e,"\x3c/script>");b=c(b);b.hasPassback=!0;return b}return{isBadImp:!0,hasPassback:!1,tagAdTag:d,tagPassback:f}};return c(b)}function C(b,d,f,e,c,p,k,l,g,r,h,u){void 0==d.dvregion&&(d.dvregion=0);try{e.depth=K(e);var q=L(e);var m="&aUrl="+encodeURIComponent(q.url);var n="&aUrlD="+q.depth;var v=e.depth+c;p&&e.depth--}catch(M){n=m=v=e.depth=""}void 0!=d.aUrl&&(m="&aUrl="+d.aUrl);a:{try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv){var t=1;break a}}catch(M){}t=
0}p=function(){function b(c){d++;var e=c.parent==c;return c.mraid||e?c.mraid:20>=d&&b(c.parent)}var c=window._dv_win||window,d=0;try{return b(c)}catch(V){}}();c=d.script.src;t="&ctx="+(dv_GetParam(c,"ctx")||"")+"&cmp="+(dv_GetParam(c,"cmp")||"")+"&plc="+(dv_GetParam(c,"plc")||"")+"&sid="+(dv_GetParam(c,"sid")||"")+"&advid="+(dv_GetParam(c,"advid")||"")+"&adsrv="+(dv_GetParam(c,"adsrv")||"")+"&unit="+(dv_GetParam(c,"unit")||"")+"&isdvvid="+(dv_GetParam(c,"isdvvid")||"")+"&uid="+d.uid+"&tagtype="+(dv_GetParam(c,
"tagtype")||"")+"&adID="+(dv_GetParam(c,"adID")||"")+"&app="+(dv_GetParam(c,"app")||"")+"&sup="+(dv_GetParam(c,"sup")||"")+"&isovv="+t+"&gmnpo="+(dv_GetParam(c,"gmnpo")||"")+"&crt="+(dv_GetParam(c,"crt")||"");"1"==dv_GetParam(c,"foie")&&(t+="&foie=1");p&&(t+="&ismraid=1");(p=dv_GetParam(c,"xff"))&&(t+="&xff="+p);h&&(t+="&dvp_sfr=1");u&&(t+="&dvp_sfe=1");(h=dv_GetParam(c,"useragent"))&&(t+="&useragent="+h);t+="&dup="+dv_GetParam(c,"dup");void 0!=window._dv_win.$dvbs.CommonData.BrowserId&&void 0!=window._dv_win.$dvbs.CommonData.BrowserVersion&&
void 0!=window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent?h={ID:window._dv_win.$dvbs.CommonData.BrowserId,version:window._dv_win.$dvbs.CommonData.BrowserVersion,ID_UA:window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent}:(h=N(h?decodeURIComponent(h):navigator.userAgent),window._dv_win.$dvbs.CommonData.BrowserId=h.ID,window._dv_win.$dvbs.CommonData.BrowserVersion=h.version,window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent=h.ID_UA);t+="&brid="+h.ID+"&brver="+h.version+"&bridua="+h.ID_UA;
(h=dv_GetParam(c,"turl"))&&(t+="&turl="+h);(h=dv_GetParam(c,"tagformat"))&&(t+="&tagformat="+h);t+=O();r=r?"&dvf=0":"";h=E("maple")?"&dvf=1":"";d=(window._dv_win.dv_config.verifyJSURL||d.protocol+"//"+(window._dv_win.dv_config.bsAddress||"rtb"+d.dvregion+".doubleverify.com")+"/verify.js")+"?jsCallback="+d.callbackName+"&jsTagObjCallback="+d.tagObjectCallbackName+"&num=6"+t+"&srcurlD="+e.depth+"&ssl="+d.ssl+r+h+"&refD="+v+d.tagIntegrityFlag+d.tagHasPassbackFlag+"&htmlmsging="+(k?"1":"0");(e=dv_GetDynamicParams(c,
"dvp").join("&"))&&(d+="&"+e);(e=dv_GetDynamicParams(c,"dvpx").join("&"))&&(d+="&"+e);if(!1===l||g)d=d+("&dvp_isBodyExistOnLoad="+(l?"1":"0"))+("&dvp_isOnHead="+(g?"1":"0"));f="srcurl="+encodeURIComponent(f);(l=P())&&(f+="&ancChain="+encodeURIComponent(l));l=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(l=2E3);if(g=dv_GetParam(c,"referrer"))g="&referrer="+g,d.length+g.length<=l&&(d+=g);(g=dv_GetParam(c,"prr"))&&(d+="&prr="+g);(g=dv_GetParam(c,"iframe"))&&(d+="&iframe="+
g);(g=dv_GetParam(c,"gdpr"))&&(d+="&gdpr="+g);(g=dv_GetParam(c,"gdpr_consent"))&&(d+="&gdpr_consent="+g);m.length+n.length+d.length<=l&&(d+=n,f+=m);(m=Q())&&(d+="&m1="+m);(m=R())&&0<m.f&&(d+="&bsig="+m.f,d+="&usig="+m.s);navigator&&navigator.hardwareConcurrency&&(d+="&noc="+navigator.hardwareConcurrency);d+=S();m=T();d+="&vavbkt="+m.vdcd;d+="&lvvn="+m.vdcv;""!=m.err&&(d+="&dvp_idcerr="+encodeURIComponent(m.err));"prerender"===window._dv_win.document.visibilityState&&(d+="&prndr=1");(m=dv_GetParam(c,
"wrapperurl"))&&1E3>=m.length&&d.length+m.length<=l&&(d+="&wrapperurl="+m);d+="&"+b.getVersionParamName()+"="+b.getVersion();b="&eparams="+encodeURIComponent(y(f));d=d.length+b.length<=l?d+b:d+"&dvf=3";return{isSev1:!1,url:d}}function O(){var b="";try{var d=window._dv_win.parent;b+="&chro="+(void 0===d.chrome?"0":"1");b+="&hist="+(d.history?d.history.length:"");b+="&winh="+d.innerHeight;b+="&winw="+d.innerWidth;b+="&wouh="+d.outerHeight;b+="&wouw="+d.outerWidth;d.screen&&(b+="&scah="+d.screen.availHeight,
b+="&scaw="+d.screen.availWidth)}catch(f){}return b}function T(){var b=[],d=function(c){e(c,null!=c.AZSD,9);e(c,c.location.hostname!=c.encodeURIComponent(c.location.hostname),10);e(c,null!=c.cascadeWindowInfo,11);e(c,null!=c._rvz,32);e(c,null!=c.FO_DOMAIN,34);e(c,null!=c.va_subid,36);e(c,c._GPL&&c._GPL.baseCDN,40);e(c,f(c,"__twb__")&&f(c,"__twb_cb_"),43);e(c,null!=c.landingUrl&&null!=c.seList&&null!=c.parkingPPCTitleElements&&null!=c.allocation,45);e(c,f(c,"_rvz",function(c){return null!=c.publisher_subid}),
46);e(c,null!=c.cacildsFunc&&null!=c.n_storesFromFs,47);e(c,c._pcg&&c._pcg.GN_UniqueId,54);e(c,f(c,"__ad_rns_")&&f(c,"_$_"),64);e(c,null!=c.APP_LABEL_NAME_FULL_UC,71);e(c,null!=c._priam_adblock,81);e(c,c.supp_ads_host&&c.supp_ads_host_overridden,82);e(c,c.uti_xdmsg_manager&&c.uti_xdmsg_manager.cb,87);e(c,c.LogBundleData&&c.addIframe,91);e(c,c.xAdsXMLHelperId||c.xYKAffSubIdTag,95);e(c,c.__pmetag&&c.__pmetag.uid,98);e(c,c.CustomWLAdServer&&/(n\d{1,4}adserv)|(1ads|cccpmo|epommarket|epmads|adshost1)/.test(c.supp_ads_host_overridden),
100)},f=function(c,b,d){for(var e in c)if(-1<e.indexOf(b)&&(!d||d(c[e])))return!0;return!1},e=function(c,d,e){d&&-1==b.indexOf(e)&&b.push((c==window.top?-1:1)*e)};try{return function(){for(var c=window,b=0;10>b&&(d(c),c!=window.top);b++)try{c.parent.document&&(c=c.parent)}catch(k){break}}(),{vdcv:28,vdcd:b.join(","),err:void 0}}catch(c){return{vdcv:28,vdcd:"-999",err:c.message||"unknown"}}}function K(b){for(var d=0;10>d&&b!=window._dv_win.top;)d++,b=b.parent;return d}function L(b){try{if(1>=b.depth)return{url:"",
depth:""};var d=[];d.push({win:window._dv_win.top,depth:0});for(var f,e=1,c=0;0<e&&100>c;){try{if(c++,f=d.shift(),e--,0<f.win.location.toString().length&&f.win!=b)return 0==f.win.document.referrer.length||0==f.depth?{url:f.win.location,depth:f.depth}:{url:f.win.document.referrer,depth:f.depth-1}}catch(l){}var p=f.win.frames.length;for(var k=0;k<p;k++)d.push({win:f.win.frames[k],depth:f.depth+1}),e++}return{url:"",depth:""}}catch(l){return{url:"",depth:""}}}function P(){var b=window._dv_win[y("=@42E:@?")][y("2?46DE@C~C:8:?D")];
if(b&&0<b.length){var d=[];d[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var f=0;f<b.length;f++)d[f+1]=b[f];return d.reverse().join(",")}return null}function y(b){new String;var d=new String,f;for(f=0;f<b.length;f++){var e=b.charAt(f);var c="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(e);0<=c&&(e="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((c+
47)%94));d+=e}return d}function w(){return Math.floor(1E12*(Math.random()+""))}function N(b){for(var d=[{id:4,brRegex:"OPR|Opera",verRegex:"(OPR/|Version/)"},{id:1,brRegex:"MSIE|Trident/7.*rv:11|rv:11.*Trident/7|Edge/|Edg/",verRegex:"(MSIE |rv:| Edge/|Edg/)"},{id:2,brRegex:"Firefox",verRegex:"Firefox/"},{id:0,brRegex:"Mozilla.*Android.*AppleWebKit(?!.*Chrome.*)|Linux.*Android.*AppleWebKit.* Version/.*Chrome",verRegex:null},{id:0,brRegex:"AOL/.*AOLBuild/|AOLBuild/.*AOL/|Puffin|Maxthon|Valve|Silk|PLAYSTATION|PlayStation|Nintendo|wOSBrowser",
